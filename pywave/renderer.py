...
class Renderer:
    ...
    def brick(self, symbol: str, b: pywave.Brick, **kwargs) -> str:
        """
    ...
    def _reduce_wavelane(self, name: str, wavelane: str, **kwargs):
        ...
        for i, b in enumerate(wavelane * repeat):
            ...
            if (
                i == 0
                and brick == pywave.BRICKS.repeat
                and prev_brick in [None, pywave.BRICKS.gap]
            ):
            ...
            if pywave.BRICKS.is_repeating_symbol(brick):
                ...
                if (
                    pywave.BRICKS.is_clock(last_valid_brick)
                    or prev_brick == pywave.BRICKS.gap
                ):
            ...
            if new_brick > 0:
                ...
                da.append(
                    data[0]
                    if data and pywave.BRICKS.need_data(brick)
                    else da[-2]
                ...
                ana.append(
                    analogue[0]
                    if analogue and pywave.BRICKS.need_equation(brick)
                    else ana[-2]
                ...
                att.append(
                    attributes[0]
                    if attributes and pywave.BRICKS.need_attribute(brick)
                    else att[-2]
                ...
                rp.append(
                    reg_pos[0]
                    if reg_pos and pywave.BRICKS.need_position(brick)
                    else rp[-2]
